            ...
            <AnimatePresence mode="wait">
                {loading ? (
                    ...
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        transition={{ duration: 0.5 }}
                        className="flex-grow"></motion.div>
                )}
            </AnimatePresence>
            ...
            <main>
                ...
                <section
                    ...
                    <p className="text-xl md:text-2xl max-w-[750px] text-center">
                        I&apos;m a developer who loves creating meaningful
                        digital experiences, with a focus on tech, minimalism,
                ...
                <section
                        ...
                        <div className="md:col-span-1 md:col-start-2">
                            <div className="space-y-8">
                                <p className="text-sm text-[#fefeff]">
                                    I&apos;m a fresh graduate currently working
                                    as a manufacturing technician at HP Inc.,
                                    though my true passion lies in software
                                    engineering and data science. Based in
                                    Seattle, WA, I thrive in an office
                                    environment where I can engage with
                                    technology and innovative ideas. I&apos;ve
                                    also had the opportunity to work with
                                    Parchment—a startup in Austin, TX—which
                                    further fueled my drive to grow in the tech
                                    space.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-1 md:col-start-3 md:mt-32">
                            <div className="space-y-8">
                                <p className="text-sm text-[#fefeff]">
                                    ...
                                    methodical: I break challenges down into
                                    smaller tasks and tackle them steadily and
                                    consistently. I believe in exploring
                                    different perspectives and embracing
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="md:col-span-1 md:col-start-2">
                            <div className="space-y-8">
                                <p className="text-sm text-[#fefeff]">
                                    In my free time, I pursue a range of
                                    activities that keep both my mind and body
                                    active. I enjoy playing sports, with
                                    basketball and golf being my current focus,
                                    and I find creative satisfaction in personal
                                    projects—most notably, this portfolio
                                    website, which I&apos;m incredibly proud of.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-1 md:col-start-3 md:mt-32">
                            <div className="space-y-8">
                                <p className="text-sm text-[#fefeff]">
                                    ...
                                    capital and expertise necessary to launch my
                                    own business. While I&apos;m still at the
                                    beginning of my professional journey and
                                    eager to connect with mentors and peers, I
                                    am committed to continuous growth and
                                    innovation in every aspect of my work.
                                </p>
                            </div>
                        </div>
                    </div>
